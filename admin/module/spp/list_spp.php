            ...
            <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Laporan Pembayaran SPP Siswa</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <?php 
                          ...
                          $kueriSpp = mysqli_query($koneksi, "SELECT * FROM tbl_spp");
                        ...
                        <tr>
                                    ...
                                    <td>
                                     <?php
                                        $kueriJur = mysqli_query($koneksi, "SELECT * FROM tbl_bulan"); 
                                        while ($jur = mysqli_fetch_array($kueriJur)) {
                                        if($spp['id_bulan'] == $jur['id_bulan']){echo $jur['bulan'];}
                                        } ?>
                                    </td>
